...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></section><section id="post" class="resource-group"><h2 class="group-heading">Post <a href="#post" class="permalink">&para;</a></h2><div id="post-posts" class="resource"><h3 class="resource-heading">Posts <a href="#post-posts" class="permalink">&nbsp;&para;</a></h3><div id="post-posts-get" class="action get"><h4 class="action-heading"><div class="name">Listar todos os posts</div><a href="#post-posts-get" class="method get">GET</a><code class="uri">/api/posts{clientId}{tag}{page}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">https://pa-desafio.herokuapp.com</span>/api/posts<span class="hljs-attribute" title="clientId">clientId=86da7s6d887fad5g7a</span><span class="hljs-attribute" title="tag">&tag=node</span><span class="hljs-attribute" title="page">&page=2</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>tag</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>&amp;tag=node</span></span><blockquote>
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></section><section id="tag" class="resource-group"><h2 class="group-heading">Tag <a href="#tag" class="permalink">&para;</a></h2><div id="tag-tags" class="resource"><h3 class="resource-heading">Tags <a href="#tag-tags" class="permalink">&nbsp;&para;</a></h3><div id="tag-tags-get" class="action get"><h4 class="action-heading"><div class="name">Listar todas as tags</div><a href="#tag-tags-get" class="method get">GET</a><code class="uri">/api/tags{clientId}{page}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">https://pa-desafio.herokuapp.com</span>/api/tags<span class="hljs-attribute" title="clientId">?clientId=86da7s6d887fad5g7a</span><span class="hljs-attribute" title="page">&page=2</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>page</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>&amp;page=2</span></span><blockquote>
<p>Número da pagina a ser exibida.</p>
</blockquote>
</dd><dt>clientId</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>?clientId=86da7s6d887fad5g7a</span></span><blockquote>
<p>Chave utilizada nos requests para autorização.</p>
...
</span>}</code></pre><div style="height: 1px;"></div></div></div></div></div></section><section id="user" class="resource-group"><h2 class="group-heading">User <a href="#user" class="permalink">&para;</a></h2><div id="user-users" class="resource"><h3 class="resource-heading">Users <a href="#user-users" class="permalink">&nbsp;&para;</a></h3><div id="user-users-get" class="action get"><h4 class="action-heading"><div class="name">Listar users</div><a href="#user-users-get" class="method get">GET</a><code class="uri">/api/users{clientId}{page}</code></h4><h4>Example URI</h4><div class="definition"><span class="method get">GET</span>&nbsp;<span class="uri"><span class="hostname">https://pa-desafio.herokuapp.com</span>/api/users<span class="hljs-attribute" title="clientId">?clientId=86da7s6d887fad5g7a</span><span class="hljs-attribute" title="page">&page=2</span></span></div><div class="title"><strong>URI Parameters</strong><div class="collapse-button show"><span class="close">Hide</span><span class="open">Show</span></div></div><div class="collapse-content"><dl class="inner"><dt>page</dt><dd><code>string</code>&nbsp;<span>(optional)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>&amp;page=2</span></span><blockquote>
<p>Número da pagina a ser exibida.</p>
</blockquote>
</dd><dt>clientId</dt><dd><code>string</code>&nbsp;<span class="required">(required)</span>&nbsp;<span class="text-muted example"><strong>Example:&nbsp;</strong><span>?clientId=86da7s6d887fad5g7a</span></span><blockquote>
<p>Chave utilizada nos requests para autorização.</p>
